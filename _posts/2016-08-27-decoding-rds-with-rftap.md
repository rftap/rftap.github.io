...
You'll need to install [GNU Radio from source](http://gnuradio.org/redmine/projects/gnuradio/wiki/InstallingGRFromSource) (I followed [these instructions](https://github.com/gnuradio/pybombs/blob/master/README.md)), and install GNU Radio's [RDS receiver (gr-rds)](https://github.com/jonathanbrucker/gr-rds). You'll also need some SDR hardware, such as the [RTL-SDR](http://www.rtl-sdr.com/about-rtl-sdr/) receiver.
